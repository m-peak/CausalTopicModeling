...
Please go to [Online Jupyter Notebook](https://mybinder.org/v2/git/https:/github.com/masamip2/CourseProject/HEAD) of this project and see the section 'How to Use/Test the Software' in the [ProjectReport.pdf](/ProjectReport.pdf) for the details of the software usage and testing the software.
